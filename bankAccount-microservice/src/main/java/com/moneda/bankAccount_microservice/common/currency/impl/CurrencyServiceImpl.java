package com.moneda.bankAccount_microservice.common.currency.impl;
...
import com.moneda.bankAccount_microservice.common.currency.repositories.CurrencyRepository;
...
public class CurrencyServiceImpl implements CurrencyService {
    ...
    @Override
    public ResponseEntity<Map<String, Object>> updateCurrency(UUID id, UpdateCurrencyDto currencyDto, BindingResult result) {
        Map<String, Object> response = new HashMap<>();
        if(result.hasErrors()){
            List<String> errors = result.getFieldErrors().stream()
                    .map(err->"El campo '" + err.getField() + "' " + err.getDefaultMessage())
